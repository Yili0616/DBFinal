...
//                                System.out.println("Insert into Conflict Values('" + name + "','" + cardNo + "'," + timestamp + ")");
//                                con.update("Insert into Conflict Values('" + name + "','" + cardNo + "'," + timestamp + ")");
                                    }
                                }
                            }
        ...
        window.showAndWait();
//        ((Pane) scene2.getRoot()).getChildren().add(scene.getRoot());
